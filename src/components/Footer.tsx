...
import { NAV_ITEMS, PHONE_DISPLAY, EMAIL, INSTAGRAM_HANDLE, INSTAGRAM_URL, JOBS_FORM_URL, REGIAO, waLink } from '../lib/site'
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-6 max-w-[30ch] text-[15.5px] leading-relaxed text-white/50">
              Limpeza residencial, pós-obra, pós-mudança e comercial em {REGIAO}.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 text-[15.5px] leading-relaxed text-white/55">Vagas abertas para diaristas em todo o estado.</p>
            <a
              href={JOBS_FORM_URL}
              target="_blank"
