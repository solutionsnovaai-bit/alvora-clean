...
const QA: { q: string; a: ReactNode }[] = [
  ...
  },
  {
    ...
    a: 'Atendemos todo o estado de São Paulo, da capital ao interior, com equipe organizada por região. Mande a cidade e o bairro no WhatsApp que a gente confirma a disponibilidade e as datas mais próximas.',
  },
  {
